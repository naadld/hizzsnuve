            ...
            <main class="content-viewport">
                ...
                <div class="view-panel" id="viewLLM">
                    ...
                    <div class="llm-grid" id="llmGridContainer">
                        <div class="llm-card" id="llmCard_0">
                            <div class="llm-card-header"><span class="llm-title">Gemini Key #1</span><span class="llm-tier">Gemini 2.5 Flash</span></div>
                            <div style="display:flex; justify-content:space-between; align-items:center; margin-top: 0.5rem;"><span class="llm-status online" id="llmStatus_0">● READY</span><span style="font-size: 0.78rem; color: var(--text-muted);" id="llmLatency_0">180ms</span></div>
                        </div>
                        <div class="llm-card" id="llmCard_1">
                            <div class="llm-card-header"><span class="llm-title">Gemini Key #2</span><span class="llm-tier">Gemini 2.5 Flash</span></div>
                            <div style="display:flex; justify-content:space-between; align-items:center; margin-top: 0.5rem;"><span class="llm-status online" id="llmStatus_1">● READY</span><span style="font-size: 0.78rem; color: var(--text-muted);" id="llmLatency_1">195ms</span></div>
                        </div>
                        <div class="llm-card" id="llmCard_2">
                            <div class="llm-card-header"><span class="llm-title">Gemini Key #3</span><span class="llm-tier">Gemini 2.5 Flash</span></div>
                            <div style="display:flex; justify-content:space-between; align-items:center; margin-top: 0.5rem;"><span class="llm-status online" id="llmStatus_2">● READY</span><span style="font-size: 0.78rem; color: var(--text-muted);" id="llmLatency_2">210ms</span></div>
                        </div>
                        <div class="llm-card" id="llmCard_3">
                            <div class="llm-card-header"><span class="llm-title">Gemini Key #4</span><span class="llm-tier">Gemini 2.5 Flash</span></div>
                            <div style="display:flex; justify-content:space-between; align-items:center; margin-top: 0.5rem;"><span class="llm-status online" id="llmStatus_3">● READY</span><span style="font-size: 0.78rem; color: var(--text-muted);" id="llmLatency_3">175ms</span></div>
                        </div>
                        <div class="llm-card" id="llmCard_4">
                            <div class="llm-card-header"><span class="llm-title">Gemini Key #5</span><span class="llm-tier">Gemini 2.5 Flash</span></div>
                            <div style="display:flex; justify-content:space-between; align-items:center; margin-top: 0.5rem;"><span class="llm-status online" id="llmStatus_4">● READY</span><span style="font-size: 0.78rem; color: var(--text-muted);" id="llmLatency_4">190ms</span></div>
                        </div>
                        <div class="llm-card" id="llmCard_5">
                            <div class="llm-card-header"><span class="llm-title">Gemini Key #6</span><span class="llm-tier">Gemini 2.5 Flash</span></div>
                            <div style="display:flex; justify-content:space-between; align-items:center; margin-top: 0.5rem;"><span class="llm-status online" id="llmStatus_5">● READY</span><span style="font-size: 0.78rem; color: var(--text-muted);" id="llmLatency_5">205ms</span></div>
                        </div>
                        <div class="llm-card" id="llmCard_6">
                            <div class="llm-card-header"><span class="llm-title">Agnes AI #1</span><span class="llm-tier">Agnes 2.5 Flash</span></div>
                            <div style="display:flex; justify-content:space-between; align-items:center; margin-top: 0.5rem;"><span class="llm-status online" id="llmStatus_6">● READY</span><span style="font-size: 0.78rem; color: var(--text-muted);" id="llmLatency_6">240ms</span></div>
                        </div>
                        <div class="llm-card" id="llmCard_7">
                            <div class="llm-card-header"><span class="llm-title">Agnes AI #2</span><span class="llm-tier">Agnes 2.5 Flash</span></div>
                            <div style="display:flex; justify-content:space-between; align-items:center; margin-top: 0.5rem;"><span class="llm-status online" id="llmStatus_7">● READY</span><span style="font-size: 0.78rem; color: var(--text-muted);" id="llmLatency_7">250ms</span></div>
                        </div>
                        <div class="llm-card" id="llmCard_8">
                            <div class="llm-card-header"><span class="llm-title">Agnes AI #3</span><span class="llm-tier">Agnes 2.5 Flash</span></div>
                            <div style="display:flex; justify-content:space-between; align-items:center; margin-top: 0.5rem;"><span class="llm-status online" id="llmStatus_8">● READY</span><span style="font-size: 0.78rem; color: var(--text-muted);" id="llmLatency_8">235ms</span></div>
                        </div>
                        <div class="llm-card" id="llmCard_9">
                            <div class="llm-card-header"><span class="llm-title">Agnes AI #4</span><span class="llm-tier">Agnes 2.5 Flash</span></div>
                            <div style="display:flex; justify-content:space-between; align-items:center; margin-top: 0.5rem;"><span class="llm-status online" id="llmStatus_9">● READY</span><span style="font-size: 0.78rem; color: var(--text-muted);" id="llmLatency_9">260ms</span></div>
                        </div>
                        <div class="llm-card" id="llmCard_10">
                            <div class="llm-card-header"><span class="llm-title">Cloudflare Workers AI</span><span class="llm-tier">DeepSeek R1 Distill</span></div>
                            <div style="display:flex; justify-content:space-between; align-items:center; margin-top: 0.5rem;"><span class="llm-status online" id="llmStatus_10">● READY</span><span style="font-size: 0.78rem; color: var(--text-muted);" id="llmLatency_10">95ms</span></div>
                        </div>
                    </div>
                </div>
